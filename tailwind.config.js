...
module.exports = {
  content: ["./index.html", "./src/**/*.{js,ts,jsx,tsx}", "./upsell1-completopopup/*.html", "./upsell1-completo/*.html", "./downsell1-completopopup/*.html", "./downsell1-completo/*.html", "./thanks/*.html"],
  theme: {
    extend: {
      colors: {
